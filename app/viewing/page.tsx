    ...
    return (
        <main className="min-h-screen bg-[#f4f2ed] text-[#202522]">
            <header className="border-b border-[#dcd9d1] bg-[#202522] text-[#f8f7f3]">
                <div className="mx-auto flex max-w-7xl items-center justify-between gap-5 px-5 py-5 sm:px-8 sm:py-6"><a href="/viewing" className="flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center rounded-full bg-[#397052] text-xl font-black">I</span><span><strong className="block text-lg leading-none">Inday Rental</strong><small className="mt-1 block text-[10px] uppercase tracking-[0.2em] text-[#aeb4ac]">Find your next room</small></span></a></div>
            </header>
